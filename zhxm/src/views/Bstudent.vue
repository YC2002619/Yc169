  ...
  <div class="div_d">
    <div class="div_d1">
      <div class="demo-input-suffix div_d2">
        学员名称：
        <el-input placeholder="请输入学员名称" v-model="studentName" clearable class="el_input_1"></el-input>
      </div>

      <div class="demo-input-suffix div_d2">
        <label for>学号：</label> 
        <el-input placeholder="请输入学号" v-model="studentNo" clearable class="el_input_1"></el-input>
      </div>

      <div class="demo-input-suffix div_d2">
        <label for>班级：</label>
        <el-input placeholder="请输入班级" v-model="className" clearable class="el_input_1"></el-input>
      </div>

      <div class="demo-input-suffix div_d2">
        <label for>宿舍栋号：</label>
        <el-select v-model="dictLabel1" placeholder="请输入宿舍栋号">
          <el-option
      ...
      <div class="demo-input-suffix div_d2">
        ...
        <el-select v-model="dictLabel2" placeholder="请输入宿舍楼层">
          <el-option
      ...
      <div class="demo-input-suffix div_d2">
        <label for>状态：</label>
        <el-select v-model="status" placeholder="学员状态">
          <el-option
